...
residual(12) = lhs - rhs;
lhs = 1;
rhs = params(12)*T(5)+(1-params(12))*y(12)^(1-params(11));
residual(13) = lhs - rhs;
lhs = y(11);
rhs = (1-params(12))*y(12)^((-params(11))/(1-params(1)))+y(11)*T(6);
residual(14) = lhs - rhs;
lhs = y(12)^(1+params(11)*params(1)/(1-params(1)));
rhs = params(11)*y(13)/y(14)*(1-params(13))/(params(11)-1);
residual(15) = lhs - rhs;
lhs = y(13);
rhs = y(15)*T(9)+y(13)*T(10);
residual(16) = lhs - rhs;
lhs = y(14);
rhs = T(9)+y(14)*T(5)*params(2)*params(12);
residual(17) = lhs - rhs;
lhs = y(22);
rhs = log(y(8));
residual(18) = lhs - rhs;
